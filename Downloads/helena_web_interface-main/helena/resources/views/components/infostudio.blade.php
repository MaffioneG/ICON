                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">                
                                ...
                                ?>
                                <h4> <b> Orari di Apertura:</b></h4>  <h5><?php echo $ora; ?> </h5>
                                <hr>
                                ...
                                <?php                           
                                    ...
                                    if( mysqli_num_rows($result) != 0){
                                        while ($row = mysqli_fetch_array($result)) {
                                            $servizio = $row['nome'];  
                                            echo"<h5>";
                                            echo "<a href=" ,route('doc') ,"?id=",$servizio,">",$servizio,"</a>";
                                            echo"</h5>";           
                                        }
                                    }
                                ?>                               
                                <form  action="{{ route('aggiornalab') }}" method="GET"  class="form-container">
                                    <br> <br>
